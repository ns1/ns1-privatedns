...
class AutoTTestTestCase(unittest.TestCase):
    ...
    def test_read_records_file_normal_case(self):
        ...
        self.assertEqual(
            list(read_records_file(normal_file)),
            expected,
            msg='return_list=False'
        )
    ...
    def test_read_records_file_duplicate_records(self):
        ...
        self.assertEqual(
            list(read_records_file(duplicate_file)),
            expected,
            msg='return_list=False'
        )
    ...
    def test_read_records_file_blank_file(self):
        ...
        expected = []
        self.assertEqual(
            list(read_records_file(blank_file)),
            expected,
            msg='return_list=False'
        )
    ...
    def test_diff_check(self):
        ...
        for param in KEY_PARAMS:
            ...
            with self.assertRaises(
                ResponseDifference,
                msg=f'non-matching answers - parameter: {param}'
            ):
                diff_check(answers)
    ...
    def test_get_distribution(self):
        ...
        self.assertEqual(
            get_distribution(domain, record_type, servers),
            expected
        )
